...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.sha1hash'
        db.add_column('main_response', 'sha1hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.sha1hash'
        db.delete_column('main_response', 'sha1hash')
    ...
    models = {
        ...
        'main.response': {
            ...
            'sha1hash': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
